...
public abstract class MutableUserType implements UserType {
     ...
     * <p>
     * Expects {@link #deepCopy(Object)} to return a {@code Serializable}. <strong>Subtypes whose {@code deepCopy}
     * implementation returns a non-serializable object must override this method.</strong>
     */
    @Override
